...
% What happens mid-season with microbes?
\\
...
\\
% I am going to skip the tropics bit (but here are the notes), as I don't think we have much important to say: Tropics biotic forces may dominate (seed predation, disease, pollinators, seed dispersers) but small changes in abiotic forces may have large effects. .  . .
\noindent {\bf Links from plant strategies to traits and ecosystems}\\
\\
...
\\
\noindent {\bf Major fundamental questions in plant strategies, phenology \& invasions}\\
\\
...
\begin{figure}[h!]
\centering
\noindent \includegraphics[width=1.1\textwidth]{/Users/Lizzie/Documents/git/manuscripts/invasionphenology/figures/invasionphen_commphen.png}
